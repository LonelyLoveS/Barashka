// Список комплиментов
const compliments = [
    "Твоя улыбка озаряет этот мир!",
    "Самая прекрасная и удивительная!",
    "Твои глаза — как звезды в ночи!",
    "Ты делаешь каждый день особенным!",
    "Красота затмевает весенние цветы!",
    "С тобой мир становится ярче!",
    "Прекрасна во всех смыслах!",
    "Твоя душа чиста, как весеннее небо!",
    "Украшаешь все вокруг своим присутствием!",
    "Объятия — наш любимый уголок в мире!",
    "Делаешь невозможное возможным!",
    "Увлекательная история!",
    "Восхитительна во всем!",
    "Ты одна из причин для улыбки!",
    "Ты как весна — несёшь тепло и радость!",
    "Барашка, на 8 марта грустить незя!",
    "Pov: Пушистик иногда бьёт деда(",
    "Не закрыла сезон вместе со мной",
    "Бебебебебеб"
];
...
const mediaData = [
    {
        ...
        comment: 'Тут я нарисовал нечто особенное! :)'
    },
    {
        type: 'image',
        src: 'images/photo2.jpg',
        comment: 'Помнишь как мы первый раз поехали на каток?)'
    },
    {
        type: 'video',
        src: 'images/video1.mp4',
        comment: 'Вечно недовольная собой Барашка! :)',
        muted: true
    },
    {
        type: 'image',
        src: 'images/photo3.jpg',
        comment: 'Особенная вещь для меня!)'
    },
    {
        type: 'image',
        src: 'images/photo4.jpg',
        comment: 'Как сказал великий учёный Дед-Инштейн ---'
    },
    {
        type: 'image',
        src: 'images/photo5.jpg',
        comment: 'За тобой следит вштыренный дедулька!:)'
    },
    {
        type: 'image',
        src: 'images/photo6.jpg',
        comment: 'Поздравляю тебя с 8 марта, "By Ded"!'
    },
